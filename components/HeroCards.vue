        ...
        >
          <div class="card w-1/3 h-full glass text-black shadow-xl">
            <div class="card-body">
              <img
                ...
                class="w-16 h-16"
              />
              <h2 class="card-title">The Intuitive Vue Framework</h2>
              <p>
          ...
          <div class="card w-1/3 h-full glass text-black shadow-xl">
            <div class="card-body">
              ...
              />
              <h2 class="card-title">Headless TypeScript ORM with a head</h2>
              <p>
          ...
          <div class="card w-1/3 h-full glass text-black shadow-xl">
            <div class="card-body">
              <img
                ...
                class="w-16 h-16 rounded-full"
              />
              <h2 class="card-title">A utility-first CSS framework</h2>
              <p>
