  ...
  <div ref="target" class=" w-4/5 flex justify-center">
    <div class="card h-96">
      <div class="card-body flex-row space-x-4 items-center justify-center p-4">
        <Transition>
          <div v-if="targetIsVisible" class="card w-1/3 h-full bg-neutral text-base-content shadow-xl">
            <div class="card-body">
              <img
              ...
              <p>
                Make web development intuitive and powerful. <br>
        ...
        <Transition>
          <div v-if="targetIsVisible" class="card w-1/3 h-full bg-neutral text-base-content shadow-xl">
            <div class="card-body">
              <img src="https://pbs.twimg.com/profile_images/1710017636166193152/7aUeiYMx_400x400.jpg" alt=""
                class="w-16 h-16 rounded-full">
              <h2 class="card-title">
                Headless TypeScript ORM with a head
              </h2>
              <p>
                Drizzle ORM is a headless TypeScript ORM with a head 🐲 <br>
                It looks and feels simple, lets you do things your way, and is
