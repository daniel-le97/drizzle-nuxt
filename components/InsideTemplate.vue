...
const sections = [
  ...
  },
  {
    ...
    subtitle: 'Premade components that I find myself using often that I enjoy',
    image: 'https://images.unsplash.com/photo-1555664424-778a1e5e1b48?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    list: [
      {
        header: 'Dynamic Routing',
        content: `Prebuilt Testimonials and Pricing plan sections that are easily customizable, have some added animation for a slight pop if that's to your taste.`,
      },
      {
        header: 'Authentication Pre Configured  for Github',
        content: `Just Plugin your Keys into a .env and then test logging in with Github!`,
      },
      {
        header: 'Page Layout and Transitions',
        content: 'Enhanced Page Layout and Transitions: Our default Nuxt layout features a dynamic NavBar and active Nuxt router links for seamless and engaging web navigation',
      ...
      <div v-for="(section, index) in sections" :key="section.title" class="flex items-center justify-center space-x-4">
        ...
        <div :class="index % 2 === 1 ? ' order-1' : ' order-0'" class=" w-1/2 flex flex-col p-5">
          ...
          <ul class="mt-8 space-y-5">
            <li v-for="l in section.list" :key="l.header">
              <div class="flex items-start justify-start space-x-4">
                <div>
                  <Icon name="uil:check-circle" size="35" class=" text-info" />
                </div>
                <div>
