<template>
 <main class="bg-white dark:bg-gray-900 min-h-screen pt-44">
  <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      ...
      <div class="flex space-x-8   justify-between">
          ...
          <div>
              ...
              <input type="text" id="subject" class="input" placeholder="Let us know how we can help you" required>
          </div>
        ...
        <div class="flex items-center justify-center">
          ...
          <div class="sm:col-span-2">
              ...
              <textarea id="message" rows="6" cols="100" class="textarea" placeholder="Leave a comment..."></textarea>
          </div>
